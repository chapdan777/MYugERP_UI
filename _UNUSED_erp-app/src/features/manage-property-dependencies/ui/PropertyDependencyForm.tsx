...
export const PropertyDependencyForm: React.FC<PropertyDependencyFormProps> = ({
    ...
    console.log('DEBUG: sourcePropertyId:', sourcePropertyId);
    console.log('DEBUG: selectedSourceProperty:', selectedSourceProperty);
    console.log('DEBUG: possibleValues type:', typeof selectedSourceProperty?.possibleValues);
